...
export const Head: FC<Props> = ({
  ...
  title = 'BLUEVINCI Market | Open Source NFT Marketplace',
  description = 'BLUEVINCI Market is an open source NFT marketplace built with BLUEVINCI.',
}) => {
  return (
    <NextHead>
      ...
      <meta property="og:image:alt" content="BLUEVINCI Market Banner" />
    </NextHead>
  )
}
